...
describe('terraform version method', () => {
...
describe('terraform class methods', () => {
  ...
  it('apply with single var-file', () => {
    ...
    const command = tf.apply({
      'vars_file': './foo.tfvars',
    }, 'dir');
    const expected = 'terraform apply -vars-file=./foo.tfvars dir';
  ...
  it('apply with array vars-file', () => {
    ...
    const expected = 'terraform apply -vars-file=foo.tfvars -vars-file=bar.tfvars dir';
